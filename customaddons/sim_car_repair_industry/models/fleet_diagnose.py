...
class fleet_diagnose(models.Model):
    ...
    def action_view_fleet_repair(self):
        ...
        result = mod_obj.get_object_reference('sim_car_repair_industry', 'action_fleet_repair_tree_view')
        id = result and result[1] or False
        result = act_obj.browse(id).read()[0]
        res = mod_obj.get_object_reference('sim_car_repair_industry', 'view_fleet_repair_form')
        result['views'] = [(res and res[1] or False, 'form')]
