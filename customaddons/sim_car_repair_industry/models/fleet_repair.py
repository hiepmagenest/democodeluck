...
class fleet_repair(models.Model):
    ...
    def action_create_fleet_diagnosis(self):
        ...
        result = mod_obj.get_object_reference('sim_car_repair_industry', 'action_fleet_diagnose_tree_view')
        id = result and result[1] or False
        result = act_obj.browse(id).read()[0]
        res = mod_obj.get_object_reference('sim_car_repair_industry', 'view_fleet_diagnose_form')
    ...
    def action_print_receipt(self):
        ...
        return self.env.ref('sim_car_repair_industry.fleet_repair_receipt_id').report_action(self)
    ...
    def action_print_label(self):
        ...
        assert len(self._ids) == 1, 'This option should only be used for a single id at a time'
        # return self.env['report'].get_action(self._ids[0],'sim_car_repair_industry.machi_rep_label_temp_id')
        return self.env.ref('sim_car_repair_industry.fleet_repair_label_id').report_action(self)
    ...
    def action_view_work_order(self):
        ...
        result = mod_obj.get_object_reference('sim_car_repair_industry', 'action_fleet_workorder_tree_view')
        id = result and result[1] or False
        result = act_obj.browse(id).read()[0]
        res = mod_obj.get_object_reference('sim_car_repair_industry', 'view_fleet_workorder_form')
        result['views'] = [(res and res[1] or False, 'form')]
