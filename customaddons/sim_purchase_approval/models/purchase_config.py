...
class ResConfigSettings(models.TransientModel):
    ...
    purchase_order_approval_rule_id = fields.Many2one('purchase.order.approval.rule',
                                                      ...
                                                      string='Purchase Order Approval Rules', readonly=False)
    purchase_order_approval = fields.Boolean(related='company_id.purchase_order_approval',
                                             string='Purchase Order Approval By Rule', readonly=False)
...
class PurchaseOrderApprovalRule(models.Model):
    ...
    approval_rule_ids = fields.One2many('purchase.order.approval.rule.lines', 'approval_rule_id',
                                        string='Approval Rule Lines')
