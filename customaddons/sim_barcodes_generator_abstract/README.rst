...
.. image:: /sim_barcodes_generator_abstract/static/description/barcode_rule_tree.png

* For manual generation, set:
    * 'Base set Manually' in 'Generate Type'
    * Set the model

.. image:: /sim_barcodes_generator_abstract/static/description/barcode_rule_form_manual.png
...
.. image:: /sim_barcodes_generator_abstract/static/description/barcode_rule_form_sequence.png
...
module that inherits on 'sim_barcodes_generator_abstract' and inherit your model
like that:
