...
class StockValuationLayer(models.Model):
    ...
    org_create_date = fields.Datetime(string='Origin Create Date', readonly=True,
                                      help="A technical field to store original create date."
    ...
    def create(self, vals_list):
        ...
        if manual_validate_date_time and records:
