...
class HrPayslip(models.Model):
    ...
    def refund_sheet(self):
        ...
        formview_ref = self.env.ref('sim_hr_payroll_community.view_hr_payslip_form', False)
        treeview_ref = self.env.ref('sim_hr_payroll_community.view_hr_payslip_tree', False)
        return {
            'name': ("Refund Payslip"),
            'view_mode': 'tree, form',
            'view_id': False,
