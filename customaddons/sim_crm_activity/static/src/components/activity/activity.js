...
class Activity extends Component {
     ...
     * @param {MouseEvent} ev
     */
    _onClickMarkDone2(ev) {
        var rpc = require('web.rpc')
        const activityID = $(event.currentTarget)[0].dataset.activityId;
        const resultID = $(event.currentTarget)[0].dataset.resultId;
           var x = $(event.currentTarget);
            rpc.query({
                model: 'mail.activity',
                method: 'mark_as_done_2',
                args: [[parseInt(activityID)],parseInt(resultID)],
